...
KNOWN_MISMATCH = {
    ...
    "例3": "(A) fixture 构卦事实与理论描述不一致: 实际世爻为巳官, 用神父母未土旺, 未形成世亥水废爻型",
    "例4": "(A) fixture 构卦事实与理论描述不一致: 实际动爻辰土化亥水, 非丑土化午火回头生",
    "例5": "(A) fixture 构卦事实与理论描述不一致: 实际用神为巳火父母, 未形成描述中的未土用神/卯木局克用",
    "例14": "(A) fixture 构卦事实与理论描述不一致: 实际动爻辰土化丑土, 非午火化未土克申金用神",
    "例15": "(A) fixture 构卦事实与理论描述不一致: 实际世爻亥水静爻, 非午火世自变亥水回头克",
    "例20": "(B) 引擎判平, 期望凶",
    "例41": "(B) 引擎判凶, 期望吉",
    "例54": "(B) 引擎判凶, 期望吉",
    "例205": "(B) 引擎判平, 期望吉",
