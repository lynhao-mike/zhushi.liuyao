...
BASELINE_RULE_HITS = {
    "例1":   {"rule_id": "P0_YONG_SHEN_SHENG_SHI",          "pattern": "用神生世局"},
    ...
    "例6":   {"rule_id": "P0_YONG_WANG_SHI_XING",            "pattern": "用旺世兴局"},
    "例7":   {"rule_id": "P0_YONG_WANG_SHI_XING",   "pattern": "用旺世兴局"},
    ...
    "例11":  {"rule_id": "P0_YONG_WANG_SHI_SHUAI",  "pattern": "用旺世衰局"},
    ...
    "例60":  {"rule_id": "P0_YONG_WANG_SHI_SHUAI",  "pattern": "用旺世衰局"},
